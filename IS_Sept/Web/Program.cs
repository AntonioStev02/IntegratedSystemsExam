...
builder.Services.AddTransient<IStudentService, StudentServiceImpl>();
builder.Services.AddTransient<ISemesterService, SemesterServiceImpl>();
builder.Services.AddTransient<IStudentOnCourseService, StudentOnCourseServiceImpl>();
